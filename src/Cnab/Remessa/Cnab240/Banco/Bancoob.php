...
class Bancoob extends AbstractRemessa implements RemessaContract
{
    ...
    public function segmentoR($nSequencialLote, BoletoContract $boleto)
    {
        ...
        $this->add(66, 66, Util::formatCnab(9, 2, 1));
        ...
        $this->add(180, 199, '');
        $this->add(200, 207, Util::formatCnab(9, $sDataBaixa, 8));
        $this->add(208, 215, Util::formatCnab(9, 0, 8));
        $this->add(216, 216, '');
    ...
    public function segmentoS($nSequencialLote, BoletoContract $boleto)
    {
        ...
        $this->add(19, 58, Util::formatCnab('X', $boleto->getInstrucoes()[0], 40));
        $this->add(59, 98, Util::formatCnab('X', $boleto->getInstrucoes()[1], 40));
        $this->add(99, 138, Util::formatCnab('X', $boleto->getInstrucoes()[2], 40));
        $this->add(139, 178, Util::formatCnab('X', $boleto->getInstrucoes()[3], 40));
        $this->add(179, 218, Util::formatCnab('X', $boleto->getInstrucoes()[4], 40));
